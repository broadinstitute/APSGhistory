...
// PHPMaker 6 configuration for Table users
$users = NULL; // Initialize table object
...
class cusers {
	...
	function cusers() {
		...
		$this->uid = new cField('users', 'x_uid', 'uid', "`uid`", 19, -1, FALSE);
		$this->fields['uid'] =& $this->uid;
		$this->username = new cField('users', 'x_username', 'username', "`username`", 200, -1, FALSE);
		$this->fields['username'] =& $this->username;
		$this->gecos = new cField('users', 'x_gecos', 'gecos', "`gecos`", 200, -1, FALSE);
		$this->fields['gecos'] =& $this->gecos;
		$this->role = new cField('users', 'x_role', 'role', "`role`", 16, -1, FALSE);
		$this->fields['role'] =& $this->role;
		$this->gid = new cField('users', 'x_gid', 'gid', "`gid`", 3, -1, FALSE);
		$this->fields['gid'] =& $this->gid;
		$this->cobj = new cField('users', 'x_cobj', 'cobj', "`cobj`", 200, -1, FALSE);

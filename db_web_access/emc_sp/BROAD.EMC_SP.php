 ...
 */
    ...
    class BROAD_EMC_SPDetailView0Page extends DetailPage
    {
        ...
        {
            $result = new Grid($this, $this->dataset, 'BROAD_EMC_SPDetailViewGrid0');
    ...
    class BROAD_EMC_SPDetailEdit0Page extends DetailPageEdit
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('BROAD_EMC_SPDetailEdit0ssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('BROAD_EMC_SPDetailEdit0asearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'BROAD_EMC_SPDetailEditGrid0');
    ...
    class BROAD_EMC_SPPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
        ...
        public function GetPageList()
        {
            ...
            $result = new PageList();
            if (GetCurrentUserGrantForDataSource('BROAD.EMC_SP')->HasViewGrant())
                $result->AddPage(new PageLink($this->RenderText('BROAD.EMC SP'), 'BROAD.EMC_SP.php', $this->RenderText('BROAD.EMC SP'), $currentPageCaption == $this->RenderText('BROAD.EMC SP')));
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('BROAD_EMC_SPssearch', $this->dataset,
                array('SAN_ARRAY', 'OBJECT_NAME', 'POLL_TIME', 'UTILIZATION_PCT', 'QUEUE_LENGTH', 'RESPONSE_TIME_MS', 'TOTAL_BANDWIDTH_MB_P_SEC', 'TOTAL_THROUGHPUT_IO_SEC', 'READ_BANDWIDTH_MB_SEC', 'READ_SIZE_KB', 'READ_THROUGHPUT_IO_SEC', 'WRITE_BANDWIDTH_MB_SEC', 'WRITE_SIZE_KB', 'WRITE_THROUGHPUTIO_SEC', 'USED_PREFETCHES_PCT', 'SP_CACHE_DIRTY_PAGES', 'SP_CACHE_FORCED_FLUSHES', 'AVERAGE_BUSY_QUEUE_LEN', 'DISK_CROSSINGS_PER_SEC', 'SERVICE_TIME_MS', 'AVERAGE_SEEK_DISTANCE_GB'),
                array($this->RenderText('SAN ARRAY'), $this->RenderText('OBJECT NAME'), $this->RenderText('POLL TIME'), $this->RenderText('UTILIZATION PCT'), $this->RenderText('QUEUE LENGTH'), $this->RenderText('RESPONSE TIME MS'), $this->RenderText('TOTAL BANDWIDTH MB P SEC'), $this->RenderText('TOTAL THROUGHPUT IO SEC'), $this->RenderText('READ BANDWIDTH MB SEC'), $this->RenderText('READ SIZE KB'), $this->RenderText('READ THROUGHPUT IO SEC'), $this->RenderText('WRITE BANDWIDTH MB SEC'), $this->RenderText('WRITE SIZE KB'), $this->RenderText('WRITE THROUGHPUTIO SEC'), $this->RenderText('USED PREFETCHES PCT'), $this->RenderText('SP CACHE DIRTY PAGES'), $this->RenderText('SP CACHE FORCED FLUSHES'), $this->RenderText('AVERAGE BUSY QUEUE LEN'), $this->RenderText('DISK CROSSINGS PER SEC'), $this->RenderText('SERVICE TIME MS'), $this->RenderText('AVERAGE SEEK DISTANCE GB')),
                array(
                    '=' => $this->GetLocalizerCaptions()->GetMessageString('equals'),
        ...
        protected function CreateGridAdvancedSearchControl($grid)
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('BROAD_EMC_SPasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('SAN_ARRAY', $this->RenderText('SAN ARRAY')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('OBJECT_NAME', $this->RenderText('OBJECT NAME')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('POLL_TIME', $this->RenderText('POLL TIME')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('UTILIZATION_PCT', $this->RenderText('UTILIZATION PCT')));
        ...
        protected function AddFieldColumns($grid)
        {
            ...
            {
              //
            // View column for BROAD_EMC_SPDetailView0 detail
            //
            $column = new DetailColumn(array('SAN_ARRAY'), 'detail0', 'BROAD_EMC_SPDetailEdit0_handler', 'BROAD_EMC_SPDetailView0_handler', $this->dataset, 'BROAD.EMC SP');
              $grid->AddViewColumn($column);
            }
        ...
        function CreateMasterDetailRecordGridForBROAD_EMC_SPDetailEdit0Grid()
        {
            $result = new Grid($this, $this->dataset, 'MasterDetailRecordGridForBROAD_EMC_SPDetailEdit0');
            $result->SetAllowDeleteSelected(false);
        ...
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'BROAD_EMC_SPGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
               $result->SetAllowDeleteSelected(false);
            else
               $result->SetAllowDeleteSelected(false);   
            ...
            // Http Handlers
            //
            $handler = new PageHTTPHandler('BROAD_EMC_SPDetailView0_handler', new BROAD_EMC_SPDetailView0Page('BROAD.EMC SP', 'BROAD.EMC SP', array('SAN_ARRAY'), GetCurrentUserGrantForDataSource('BROAD.EMC_SP.'), 'UTF-8', 20, 'BROAD_EMC_SPDetailEdit0_handler'));
            GetApplication()->RegisterHTTPHandler($handler);
            $pageEdit = new BROAD_EMC_SPDetailEdit0Page($this, array('SAN_ARRAY'), array('SAN_ARRAY'), $this->GetForeingKeyFields(), $this->CreateMasterDetailRecordGridForBROAD_EMC_SPDetailEdit0Grid(), $this->dataset, GetCurrentUserGrantForDataSource('BROAD.EMC_SP.'), 'UTF-8');
            $pageEdit->SetShortCaption('BROAD.EMC SP');
            $pageEdit->SetHeader(GetPagesHeader());
            $pageEdit->SetFooter(GetPagesFooter());
            $pageEdit->SetCaption('BROAD.EMC SP');
            $pageEdit->SetHttpHandlerName('BROAD_EMC_SPDetailEdit0_handler');
            $handler = new PageHTTPHandler('BROAD_EMC_SPDetailEdit0_handler', $pageEdit);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for SAN_ARRAY field
            //
    ...
    try
    {
        $Page = new BROAD_EMC_SPPage("BROAD.EMC_SP.php", "BROAD_EMC_SP", GetCurrentUserGrantForDataSource("BROAD_EMC_SP"), 'UTF-8');
        $Page->SetShortCaption('BROAD.EMC SP');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('BROAD.EMC SP');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("BROAD.EMC_SP"));

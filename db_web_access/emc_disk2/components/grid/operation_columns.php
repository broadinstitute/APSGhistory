            ...
            if ($this->GetImagePath() != null)
            {
                return
                    StringUtils::Format(
                        ...
                        '<a style="margin-left: 4px; margin-right: 4px;" href="#" title="%s" dialog-title="%s" modal-view="true" content-link="%s">'.
                        '<img src="%s" alt="%s">' .
                        '</a></span>',
                        $this->GetCaption(),
        ...
        if ($showButton)
        {
            if ($this->GetImagePath() != null)
            {
                return
                    StringUtils::Format(
                        '<span class="default-fade-in fade-out-on-hover" style="white-space: nowrap;">'.
                        '<a insert-after="table#%s .new-record-after-row" style="margin-left: 4px; margin-right: 4px;" href="#" title="%s" dialog-title="%s" modal-copy="true" content-link="%s">'.
                        '<img src="%s" alt="%s">' .
                        '</a></span>',

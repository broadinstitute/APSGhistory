 ...
 */
    ...
    class BROAD_EMC_DISKDetailView0Page extends DetailPage
    {
        ...
        {
            $result = new Grid($this, $this->dataset, 'BROAD_EMC_DISKDetailViewGrid0');
    ...
    class BROAD_EMC_DISKDetailEdit0Page extends DetailPageEdit
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('BROAD_EMC_DISKDetailEdit0ssearch', $this->dataset,
        ...
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('BROAD_EMC_DISKDetailEdit0asearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
        ...
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'BROAD_EMC_DISKDetailEditGrid0');
    ...
    class BROAD_EMC_DISKPage extends Page
    {
        protected function DoBeforeCreate()
        {
            $this->dataset = new TableDataset(
        ...
        public function GetPageList()
        {
            ...
            $result = new PageList();
            if (GetCurrentUserGrantForDataSource('BROAD.EMC_DISK')->HasViewGrant())
                $result->AddPage(new PageLink($this->RenderText('BROAD.EMC DISK'), 'BROAD.EMC_DISK.php', $this->RenderText('BROAD.EMC DISK'), $currentPageCaption == $this->RenderText('BROAD.EMC DISK')));
        ...
        {
            $grid->UseFilter = true;
            $grid->SearchControl = new SimpleSearch('BROAD_EMC_DISKssearch', $this->dataset,
                array('SAN_ARRAY', 'OBJECT_NAME', 'POLL_TIME', 'UTILIZATION_PCT', 'QUEUE_LENGTH', 'RESPONSE_TIME_MS', 'TOTAL_BANDWIDTH_MB_P_SEC', 'TOTAL_THROUGHPUT_IO_SEC', 'READ_BANDWIDTH_MB_SEC', 'READ_SIZE_KB', 'READ_THROUGHPUT_IO_SEC', 'WRITE_BANDWIDTH_MB_SEC', 'WRITE_SIZE_KB', 'WRITE_THROUGHPUTIO_SEC', 'USED_PREFETCHES_PCT', 'SP_CACHE_DIRTY_PAGES', 'SP_CACHE_FORCED_FLUSHES', 'AVERAGE_BUSY_QUEUE_LEN', 'DISK_CROSSINGS_PER_SEC', 'SERVICE_TIME_MS', 'AVERAGE_SEEK_DISTANCE_GB'),
                array($this->RenderText('SAN ARRAY'), $this->RenderText('OBJECT NAME'), $this->RenderText('POLL TIME'), $this->RenderText('UTILIZATION PCT'), $this->RenderText('QUEUE LENGTH'), $this->RenderText('RESPONSE TIME MS'), $this->RenderText('TOTAL BANDWIDTH MB P SEC'), $this->RenderText('TOTAL THROUGHPUT IO SEC'), $this->RenderText('READ BANDWIDTH MB SEC'), $this->RenderText('READ SIZE KB'), $this->RenderText('READ THROUGHPUT IO SEC'), $this->RenderText('WRITE BANDWIDTH MB SEC'), $this->RenderText('WRITE SIZE KB'), $this->RenderText('WRITE THROUGHPUTIO SEC'), $this->RenderText('USED PREFETCHES PCT'), $this->RenderText('SP CACHE DIRTY PAGES'), $this->RenderText('SP CACHE FORCED FLUSHES'), $this->RenderText('AVERAGE BUSY QUEUE LEN'), $this->RenderText('DISK CROSSINGS PER SEC'), $this->RenderText('SERVICE TIME MS'), $this->RenderText('AVERAGE SEEK DISTANCE GB')),
                array(
                    '=' => $this->GetLocalizerCaptions()->GetMessageString('equals'),
        ...
        protected function CreateGridAdvancedSearchControl($grid)
        {
            $this->AdvancedSearchControl = new AdvancedSearchControl('BROAD_EMC_DISKasearch', $this->dataset, $this->GetLocalizerCaptions(), $this->GetColumnVariableContainer(), $this->CreateLinkBuilder());
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('SAN_ARRAY', $this->RenderText('SAN ARRAY')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('OBJECT_NAME', $this->RenderText('OBJECT NAME')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('POLL_TIME', $this->RenderText('POLL TIME')));
            $this->AdvancedSearchControl->AddSearchColumn($this->AdvancedSearchControl->CreateStringSearchInput('UTILIZATION_PCT', $this->RenderText('UTILIZATION PCT')));
        ...
        protected function AddFieldColumns($grid)
        {
            if (GetCurrentUserGrantForDataSource('BROAD.EMC_DISK.BROAD.EMC_DISK')->HasViewGrant())
            {
              //
            // View column for BROAD_EMC_DISKDetailView0 detail
            //
            $column = new DetailColumn(array('SAN_ARRAY'), 'detail0', 'BROAD_EMC_DISKDetailEdit0_handler', 'BROAD_EMC_DISKDetailView0_handler', $this->dataset, 'BROAD.EMC DISK');
              $grid->AddViewColumn($column);
            }
        ...
        function CreateMasterDetailRecordGridForBROAD_EMC_DISKDetailEdit0Grid()
        {
            $result = new Grid($this, $this->dataset, 'MasterDetailRecordGridForBROAD_EMC_DISKDetailEdit0');
            $result->SetAllowDeleteSelected(false);
        ...
        protected function CreateGrid()
        {
            $result = new Grid($this, $this->dataset, 'BROAD_EMC_DISKGrid');
            if ($this->GetSecurityInfo()->HasDeleteGrant())
               $result->SetAllowDeleteSelected(false);
            else
               $result->SetAllowDeleteSelected(false);   
            ...
            // Http Handlers
            //
            $handler = new PageHTTPHandler('BROAD_EMC_DISKDetailView0_handler', new BROAD_EMC_DISKDetailView0Page('BROAD.EMC DISK', 'BROAD.EMC DISK', array('OBJECT_NAME'), GetCurrentUserGrantForDataSource('BROAD.EMC_DISK.BROAD.EMC_DISK'), 'UTF-8', 20, 'BROAD_EMC_DISKDetailEdit0_handler'));
            GetApplication()->RegisterHTTPHandler($handler);
            $pageEdit = new BROAD_EMC_DISKDetailEdit0Page($this, array('OBJECT_NAME'), array('SAN_ARRAY'), $this->GetForeingKeyFields(), $this->CreateMasterDetailRecordGridForBROAD_EMC_DISKDetailEdit0Grid(), $this->dataset, GetCurrentUserGrantForDataSource('BROAD.EMC_DISK.BROAD.EMC_DISK'), 'UTF-8');
            $pageEdit->SetShortCaption('BROAD.EMC DISK');
            $pageEdit->SetHeader(GetPagesHeader());
            $pageEdit->SetFooter(GetPagesFooter());
            $pageEdit->SetCaption('BROAD.EMC DISK');
            $pageEdit->SetHttpHandlerName('BROAD_EMC_DISKDetailEdit0_handler');
            $handler = new PageHTTPHandler('BROAD_EMC_DISKDetailEdit0_handler', $pageEdit);
            GetApplication()->RegisterHTTPHandler($handler);
            //
            // View column for SAN_ARRAY field
            //
    ...
    try
    {
        $Page = new BROAD_EMC_DISKPage("BROAD.EMC_DISK.php", "BROAD_EMC_DISK", GetCurrentUserGrantForDataSource("BROAD_EMC_DISK"), 'UTF-8');
        $Page->SetShortCaption('BROAD.EMC DISK');
        $Page->SetHeader(GetPagesHeader());
        $Page->SetFooter(GetPagesFooter());
        $Page->SetCaption('BROAD.EMC DISK');
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("BROAD.EMC_DISK"));

...
{
    $result = array();
    $result[] = array('caption' => 'BROAD.EMC DISK', 'short_caption' => 'BROAD.EMC DISK', 'filename' => 'BROAD.EMC_DISK.php', 'name' => 'BROAD.EMC_DISK');
    return $result;
}
...
{
    return
    '<div style="width: 100%; color: red;"><h2 style="color: red;">This website was created by evaluation version of Oracle PHP Generator Professional.</h2><h2 style="color: red;">This warning message will not appear on website created by a paid-for version of Oracle PHP Generator Professional.</h2></div>';
}

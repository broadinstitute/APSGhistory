...
abstract class Dataset implements IFilterable
{
    ...
    public function GetFieldValueAsSQLByNameForUpdate($fieldName, $value, $setToDefault = false)
    {
        return $this->GetFieldByName($fieldName)->GetValueForSql($value);
    }
    ...
    #reiong IFilterable implementation

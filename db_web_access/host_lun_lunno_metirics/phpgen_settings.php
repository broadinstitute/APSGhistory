...
{
    $result = array();
    $result[] = array('caption' => 'host-array-filesys-lun-metrics', 'short_caption' => 'host-array-filesys-lun-metrics', 'filename' => 'host-array-filesys-lun-metrics.php', 'name' => 'BROAD.HOST_LUN_LUN_NO_METRICS');
    return $result;
}

 ...
 */
    ...
    class BROAD_EMC_DISKPage extends Page
    {
        ...
        protected function AddFieldColumns($grid)
        {
            if (GetCurrentUserGrantForDataSource('BROAD_EMC_DISKDetailView0')->HasViewGrant())
            {
              //
        ...
        protected function CreateGrid()
        {
            ...
            // Http Handlers
            //
            $handler = new PageHTTPHandler('BROAD_EMC_DISKDetailView0_handler', new BROAD_EMC_DISKDetailView0Page('BROAD.EMC DISK', 'BROAD.EMC DISK', array('OBJECT_NAME'), GetCurrentUserGrantForDataSource('BROAD_EMC_DISKDetailView0'), 'UTF-8', 20, 'BROAD_EMC_DISKDetailEdit0_handler'));
            GetApplication()->RegisterHTTPHandler($handler);
            $pageEdit = new BROAD_EMC_DISKDetailEdit0Page($this, array('OBJECT_NAME'), array('SAN_ARRAY'), $this->GetForeingKeyFields(), $this->CreateMasterDetailRecordGridForBROAD_EMC_DISKDetailEdit0Grid(), $this->dataset, GetCurrentUserGrantForDataSource('BROAD_EMC_DISKDetailEdit0'), 'UTF-8');
    ...
    try
    {
        ...
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("BROAD_EMC_DISK"));

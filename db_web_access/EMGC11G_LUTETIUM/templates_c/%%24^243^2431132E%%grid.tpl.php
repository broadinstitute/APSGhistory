            ...
            <tr height="40" class="editor_buttons">
                <td colspan="4" align="center" valign="top" >
                    <input
                        class="sm_button"
                        type="button"
                        value="<?php echo $this->_tpl_vars['Captions']->GetMessageString('Save'); ?>
"
                        name="submit1"
                        onclick="<?php echo 'WriteWYSIWYGValuesToTheirTextAreas(); if (ValidateSimpleForm($(\'#editform\'), $(\'ul.editing-error-box\'), false)) { document.editform.submit(); } '; ?>
"
                    />
                    ...
                    <input
                        class="sm_button"
                        type="reset"
                        value="<?php echo $this->_tpl_vars['Captions']->GetMessageString('BackToList'); ?>
"

...
filesystem_add.FormID = "ffilesystemadd"; // form ID
...
<p><span class="phpmaker"><?php echo $Language->Phrase("Add") ?>&nbsp;<?php echo $Language->Phrase("TblTypeTABLE") ?><?php echo $filesystem->TableCaption() ?><br><br>
<a href="<?php echo $filesystem->getReturnUrl() ?>"><?php echo $Language->Phrase("GoBack") ?></a></span></p>
<?php
if (EW_DEBUG_ENABLED)
	echo ew_DebugMsg();
$filesystem_add->ShowMessage();
?>
...
&nbsp;<a name="aol_x_contact" id="aol_x_contact" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:filesystem_add,lnk:'aol_x_contact',el:'x_contact',hdr:this.innerHTML, url:'usersaddopt.php',lf:'x_uid',df:'x_uid',df2:'x_gecos',pf:'',ff:''});"><?php echo $Language->Phrase("AddLink") ?>&nbsp;<?php echo $filesystem->contact->FldCaption() ?></a>
<?php } ?>
<?php } else { ?>
<div<?php echo $filesystem->contact->ViewAttributes() ?>><?php echo $filesystem->contact->ViewValue ?></div>
...
&nbsp;<a name="aol_x_contact2" id="aol_x_contact2" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:filesystem_add,lnk:'aol_x_contact2',el:'x_contact2',hdr:this.innerHTML, url:'usersaddopt.php',lf:'x_uid',df:'x_uid',df2:'x_gecos',pf:'',ff:''});"><?php echo $Language->Phrase("AddLink") ?>&nbsp;<?php echo $filesystem->contact2->FldCaption() ?></a>
<?php } else { ?>
...
&nbsp;<a name="aol_x_rescomp" id="aol_x_rescomp" href="javascript:void(0);" onclick="ew_AddOptDialogShow({pg:filesystem_add,lnk:'aol_x_rescomp',el:'x_rescomp',hdr:this.innerHTML, url:'usersaddopt.php',lf:'x_uid',df:'x_uid',df2:'x_gecos',pf:'',ff:''});"><?php echo $Language->Phrase("AddLink") ?>&nbsp;<?php echo $filesystem->rescomp->FldCaption() ?></a>
<?php } else { ?>
...
class cfilesystem_add {
	...
	function Page_Main() {
		...
		if ($filesystem->CurrentAction == "F") { // Confirm page
		  $filesystem->RowType = EW_ROWTYPE_VIEW; // Render view type
		} else {

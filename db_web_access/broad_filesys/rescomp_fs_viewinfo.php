...
$rescomp_fs_view = NULL;

//
// Table class for rescomp_fs_view
//
class crescomp_fs_view {
	var $TableVar = 'rescomp_fs_view';
	...
	function crescomp_fs_view() {
		...
		// mount
		$this->mount = new cField('rescomp_fs_view', 'rescomp_fs_view', 'x_mount', 'mount', '`mount`', 200, -1, FALSE, '`mount`', FALSE);
		$this->fields['mount'] =& $this->mount;

		// path
		$this->path = new cField('rescomp_fs_view', 'rescomp_fs_view', 'x_path', 'path', '`path`', 200, -1, FALSE, '`path`', FALSE);
		$this->fields['path'] =& $this->path;

		// rescomp
		$this->rescomp = new cField('rescomp_fs_view', 'rescomp_fs_view', 'x_rescomp', 'rescomp', '`rescomp`', 200, -1, FALSE, '`rescomp`', FALSE);

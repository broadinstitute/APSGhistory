...
class cgrp {
	...
	function cgrp() {
		...
		// id
		$this->id = new cField('grp', 'grp', 'x_id', 'id', '`id`', 19, -1, FALSE, '`id`', FALSE);
		$this->id->FldDefaultErrMsg = $Language->Phrase("IncorrectInteger");
		$this->fields['id'] =& $this->id;

		// name
		$this->name = new cField('grp', 'grp', 'x_name', 'name', '`name`', 200, -1, FALSE, '`name`', FALSE);
		$this->fields['name'] =& $this->name;

		// parent
		$this->parent = new cField('grp', 'grp', 'x_parent', 'parent', '`parent`', 19, -1, FALSE, '`parent`', FALSE);
	...
	function InsertSQL(&$rs) {
		...
		return "INSERT INTO `grp` ($names) VALUES ($values)";
	}
	...
	// View URL
	function ViewUrl() {
		return $this->KeyUrl("grpview.php", $this->UrlParm());
	}
	...
	// Edit URL
	function EditUrl() {
		return $this->KeyUrl("grpedit.php", $this->UrlParm());
	}
	...
	// Copy URL
	function CopyUrl() {
		return $this->KeyUrl("grpadd.php", $this->UrlParm());
	}
	...
	// Delete URL
	function DeleteUrl() {
		return $this->KeyUrl("grpdelete.php", $this->UrlParm());
	}
	...
	function UrlParm($parm = "") {
		$UrlParm = ($this->UseTokenInUrl) ? "t=grp" : "";
		if ($parm <> "") {
			if ($UrlParm <> "")
				$UrlParm .= "&";
			$UrlParm .= $parm;

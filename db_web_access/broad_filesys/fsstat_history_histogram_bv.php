...
// Define page object
$fsstat_history_histogram_blobview = new cfsstat_history_histogram_blobview();
$Page =& $fsstat_history_histogram_blobview;

// Page init processing
$fsstat_history_histogram_blobview->Page_Init();

// Page main processing
$fsstat_history_histogram_blobview->Page_Main();
?>
<?php
$fsstat_history_histogram_blobview->Page_Terminate();
?>
<?php
...
// Page Class
//
class cfsstat_history_histogram_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page Object Name
	var $PageObjName = 'fsstat_history_histogram_blobview';
	...
	//  - open connection
	//
	function cfsstat_history_histogram_blobview() {
		global $conn;
	...
	function Page_Main() {
		...
		// Get key
		$objBinary = new cUpload('fsstat_history', 'x_histogram');

...
<table>
    ...
    <tr>
        ...
        <a class="hide_right_panel" href="#" onclick="<?php echo 'require(PhpGen.ModuleList([PhpGen.Module.PG.NavBar], true), function(navBar) { navBar.ToggleSideBar(); }); return false;'; ?>
">

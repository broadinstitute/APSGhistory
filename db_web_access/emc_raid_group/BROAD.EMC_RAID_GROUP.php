 ...
 */
    ...
    class BROAD_EMC_RAID_GROUPPage extends Page
    {
        ...
        protected function CreateGrid()
        {
            ...
            // Http Handlers
            //
            $handler = new PageHTTPHandler('BROAD_EMC_RAID_GROUPDetailView0_handler', new BROAD_EMC_RAID_GROUPDetailView0Page('BROAD.EMC RAID GROUP', 'BROAD.EMC RAID GROUP', array('SAN_ARRAY'), GetCurrentUserGrantForDataSource('BROAD.EMC_RAID_GROUP.'), 'UTF-8', 20, 'BROAD_EMC_RAID_GROUPDetailEdit0_handler'));
            GetApplication()->RegisterHTTPHandler($handler);
            $pageEdit = new BROAD_EMC_RAID_GROUPDetailEdit0Page($this, array('SAN_ARRAY'), array('SAN_ARRAY'), $this->GetForeingKeyFields(), $this->CreateMasterDetailRecordGridForBROAD_EMC_RAID_GROUPDetailEdit0Grid(), $this->dataset, GetCurrentUserGrantForDataSource('BROAD.EMC_RAID_GROUP.'), 'UTF-8');
    ...
    try
    {
        ...
        $Page->SetRecordPermission(GetCurrentUserRecordPermissionsForDataSource("BROAD.EMC_RAID_GROUP"));

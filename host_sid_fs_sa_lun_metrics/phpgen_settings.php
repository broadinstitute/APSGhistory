...
{
    $result = array();
    $result[] = array('caption' => 'host_sid_fs_sa_lun_metrics', 'short_caption' => 'host_sid_fs_sa_lun_metrics', 'filename' => 'host_sid_fs_sa_lun_metrics.php', 'name' => 'BROAD.HOS_SID_FS_SA_LUNNO_METRICS');
    return $result;
}

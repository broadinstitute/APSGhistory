...
define("EW_RANDOM_KEY", 'k8xVz6nleL9fAl0e', TRUE); // Random key for encryption
define("EW_PROJECT_STYLESHEET_FILENAME", "matter_challenge.css", TRUE); // Project stylesheet file name

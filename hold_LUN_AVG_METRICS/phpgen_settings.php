...
{
    $result = array();
    $result[] = array('caption' => 'BROAD.AVG LUN METRICS BY TIMESLICE', 'short_caption' => 'BROAD.AVG LUN METRICS BY TIMESLICE', 'filename' => 'BROAD.AVG_LUN_METRICS_BY_TIMESLICE.php', 'name' => 'BROAD.AVG_LUN_METRICS_BY_TIMESLICE');
    return $result;
}

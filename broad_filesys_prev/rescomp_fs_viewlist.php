...
<?php if ($rescomp_fs_view->path->Visible) { // path ?>
	...
	<?php } ?>
<?php } ?>		
<?php if ($rescomp_fs_view->gecos->Visible) { // gecos ?>
	<?php if ($rescomp_fs_view->SortUrl($rescomp_fs_view->gecos) == "") { ?>
		<td>Gecos</td>
	<?php } else { ?>
		<td class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $rescomp_fs_view->SortUrl($rescomp_fs_view->gecos) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr><td>Gecos&nbsp;(*)</td><td style="width: 10px;"><?php if ($rescomp_fs_view->gecos->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($rescomp_fs_view->gecos->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></table>
		</td>
	<?php } ?>
<?php } ?>		
<?php if ($rescomp_fs_view->Export == "") { ?>
...
<div<?php echo $rescomp_fs_view->gecos->ViewAttributes() ?>><?php echo $rescomp_fs_view->gecos->ListViewValue() ?></div>
</td>
	<?php } ?>
<?php if ($rescomp_fs_view->Export == "") { ?>
<?php
...
class crescomp_fs_view_list {
	...
	function BasicSearchSQL($Keyword) {
		...
		$sql .= $rescomp_fs_view->gecos->FldExpression . " LIKE '%" . $sKeyword . "%' OR ";
	...
	function SetUpSortOrder() {
		...
		if (@$_GET["order"] <> "") {
			...
			$rescomp_fs_view->UpdateSort($rescomp_fs_view->gecos); // Field 
	...
	function LoadRowValues(&$rs) {
		...
		$rescomp_fs_view->gecos->setDbValue($rs->fields('gecos'));
	}

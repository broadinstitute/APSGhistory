...
class PageNavigator
{
    ...
    function CreateNavigatorPages($currentPage, $pageCount, $linkBuilder)
    {
        ...
        if ($currentPage > 1)
        {
            ...
            $prevPageLink = new PageNavigatorPage($this->page, '<', $currentPage - 1, false, $linkBuilder, '', $this->GetHintForPage($currentPage - 1, 'Ctrl + left'));
            $prevPageLink->SetShortCut('Ctrl+left');
            $prevPages[] = $prevPageLink;
        }
        ...
        if ($currentPage < $pageCount)
        {
            ...
            $nextPageLink = new PageNavigatorPage($this->page, '>', $currentPage + 1, false, $linkBuilder, '', $this->GetHintForPage($currentPage + 1, 'Ctrl + right'));
            $nextPageLink->SetShortCut('Ctrl+right');
            $nextPages[] = $nextPageLink;
        }

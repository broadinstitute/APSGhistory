...
<head>
    ...
    <style type="text/css" media="all">
        @import "<ww:url value="/style/main.css"/>";
        @import "<ww:url value="/style/style.css"/>";
        @import "<ww:url value="/style/styles.css"/>";
    </style>
...
<ww:i18n name="com.atlassian.crowd.console.action.BaseAction" >
    ...
    <p>
        ...
        : <%=systemInfoHelper.getCrowdVersion()%>
    </p>
    ...
    <p>
        ...
        : <%=systemInfoHelper.getTotalMemory()%> MB<br/>
        <ww:text name="systeminfo.freememory.label"/>
        : <%=systemInfoHelper.getFreeMemory()%> MB<br/>
        <ww:text name="systeminfo.usedmemory.label"/>
        : <%=systemInfoHelper.getUsedMemory()%> MB<br/>
    </p>

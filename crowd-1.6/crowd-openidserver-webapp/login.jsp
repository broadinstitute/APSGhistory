...
<html>
    ...
    <form method="post" action="<ww:url namespace="/" action="login" includeParams="none" />" name="login">
        ...
        <div class="crowdForm">
            ...
            <div class="fieldArea">
                <div class="secondColumn">
                    <a id="forgottenpassword" href="<ww:url namespace="/" action="forgottenpassword" method="default"/>"><ww:text name="forgottenpassword.link.label" /></a>                    
                </div>
            </div>

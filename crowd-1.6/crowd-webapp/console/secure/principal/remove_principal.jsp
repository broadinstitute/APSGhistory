...
<head>
    <title>
        <ww:property value="getText('principal.remove.title')"/>
    </title>
    <meta name="section" content="users"/>
    <meta name="pagename" content="removeuser"/>
    <meta name="help.url" content="<ww:property value="getText('help.user.remove')"/>"/>    
</head>
<body>
...
<div class="crowdForm">
    ...
    <div class="formFooter wizardFooter">
        ...
        <div class="buttons">
            ...
            <form method="post" action="<ww:url namespace="/console/secure/user" action="remove" method="update" includeParams="none" />">

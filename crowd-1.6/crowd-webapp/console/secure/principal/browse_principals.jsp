...
<head>
    <title>
        <ww:property value="getText('browser.principal.title')"/>
    </title>
...
<body>
    ...
    <div class="formBodyNoTop">
       ...
       <ww:component template="form_messages.jsp"/>
        ...
        <form name="browseprincipals" method="post" action="<ww:url namespace="/console/secure/user" action="browse" includeParams="none"/>">
            <p class="miniform">
                ...
                <ww:property value="getText('principal.email.label')"/>
            ...
            <p style="text-align: center;">
                ...
                <input type="reset" class="button" value="<ww:property value="getText('browser.resetfilter.label')"/>" onclick="location.href='<ww:url namespace="/console/secure/user" action="browse" includeParams="none" />';">
            </p>

        </form>

        <table id="principal-details">
            <tr>
                <th width="35%">
                    <ww:property value="getText('principal.name.label')"/>
                </th>
            ...
            <ww:iterator value="results" status="rowstatus">
                <ww:if test="#rowstatus.count <= resultsPerPage">
                    ...
                    <td valign="top">
                        <a href="<ww:url namespace="/console/secure/user" action="view" method="default" includeParams="none" ><ww:param name="name" value="name"/><ww:param name="directoryID" value="[1].directoryID" /></ww:url>"
        ...
        <form name="next" method="post" action="<ww:url namespace="/console/secure/user" action="browse" includeParams="none" />">
        ...
        <form name="previous" method="post" action="<ww:url namespace="/console/secure/user" action="browse" includeParams="none" />">
            <input type="hidden" name="ID" value="<ww:property value="ID" />"/>
            <input type="hidden" name="directoryID" value="<ww:property value="directoryID" />"/>
            <input type="hidden" name="name" value="<ww:property value="name" />"/>
            <input type="hidden" name="email" value="<ww:property value="email" />"/>

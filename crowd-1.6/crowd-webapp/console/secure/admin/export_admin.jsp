...
<div class="tabContent create">
    ...
    <div class="crowdForm">
        ...
        <p>
            <ww:property value="getText('administration.export.text')"/>
        </p>

        <form method="post" action="<ww:url namespace="/console/secure/admin" action="export" method="execute" includeParams="none" />">

            <ww:textfield name="filePath" size="50">
                <ww:param name="label" value="getText('administration.export.filepath.label')"/>
            </ww:textfield>

...
<body>
    <p class="headingInfo">
        <a href="<ww:url namespace="/secure/role" action="addrole" method="default"  />">
    ...
    <div class="page-content">
        ...
        <form method="post" action="<ww:url namespace="/secure/role" action="browseroles" includeParams="none" />">
            ...
            <p class="miniform">
                ...
                <select name="active" style="width: 100px;">
                    <option value="">
                        <ww:property value="getText('none.label')"/>
                    </option>
                    <option value="true"
            ...
            <p style="text-align: center;">
                ...
                <input type="reset" class="button" value="<ww:property value="getText('browser.resetfilter.label')"/>" onclick="location.href='<ww:url namespace="/secure/role" action="browseroles" includeParams="none" />';">
            </p>
        ...
        <table>
            ...
            <ww:iterator value="results" status="rowstatus">
                <ww:if test="#rowstatus.count <= resultsPerPage">
                    ...
                    <td valign="top"><a href="<ww:url namespace="/secure/role" action="viewrole" method="default" ><ww:param name="name" value="name"/></ww:url>">
        ...
        <form name="next" method="post" action="<ww:url namespace="/secure/role" action="browseroles" includeParams="none" />">
        ...
        <form name="previous" method="post" action="<ww:url namespace="/secure/role" action="browseroles" includeParams="none" />">
            <input type="hidden" name="name" value="<ww:property value="name" />"/>
            <input type="hidden" name="active" value="<ww:property value="active" />"/>

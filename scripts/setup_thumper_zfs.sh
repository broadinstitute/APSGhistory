...
zfs set compress=on zpool1/$1
zfs set reserv=5T zpool1/$1 zpool1/$1_images
zfs set quota=7T zpool1/$1 zpool1/$1_images
mkdir /zpool1/$1_images/transfer /zpool1/$1/analyzed
chmod 775 /zpool1/$1_images/transfer /zpool1/$1/analyzed
chown -R prodinfo:seqswprod /zpool1/$1 /zpool1/$1_images

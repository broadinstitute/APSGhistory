...
<?php if ($rescomp_fs_view->rescomp->Visible) { // rescomp ?>
	...
	<?php } else { ?>
		<td class="ewPointer" onmousedown="ew_Sort(event,'<?php echo $rescomp_fs_view->SortUrl($rescomp_fs_view->rescomp) ?>',1);">
			<table cellspacing="0" class="ewTableHeaderBtn"><tr><td>Rescomp&nbsp;(*)</td><td style="width: 10px;"><?php if ($rescomp_fs_view->rescomp->getSort() == "ASC") { ?><img src="images/sortup.gif" width="10" height="9" border="0"><?php } elseif ($rescomp_fs_view->rescomp->getSort() == "DESC") { ?><img src="images/sortdown.gif" width="10" height="9" border="0"><?php } ?></td></tr></table>
		</td>
	<?php } ?>
<?php } ?>
<?php if ($rescomp_fs_view->Export == "") { ?>

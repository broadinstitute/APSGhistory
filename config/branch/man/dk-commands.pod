...
unalter [ B<-a> ] I<VARIABLE> I<COMPONENT> [ I<SEPARATOR> ]
...
=item alter   [ B<-a> ] I<VARIABLE> I<COMPONENT> [ I<SEPARATOR> ]

=item unalter [ B<-a> ] I<VARIABLE> I<COMPONENT> [ I<SEPARATOR> ]
...
I<Unalter> removes the first or last (B<-a>) instance of I<COMPONENT>.
...
The value of I<VARIABLE> is a list of zero or more
...
Create (or restore/remove, in the case of I<unuse>),
...
(words of the form I<\!:1>, etc.) are allowed,
and will be processed correctly by I<csh> or I<tcsh>,
but are quietly ignored by I<bash> or I<ksh>.

If I<ALIAS_NAME> has a pre-existing value,
it is saved during a I<use> operation in a new alias
named I<_dk_sal_ALIAS_NAME>.
A subsequent I<unuse> operation will restore the original alias value.

Dotkits containing the I<dk_alias> command typically
are marked as I<idempotent> by appending '++' to the
...
The I<_dk_opt_a> variable allows a package author to over-rule

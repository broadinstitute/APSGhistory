...
#set to rsync thru image collection (refer to copy_runs.py for stopping during image colection
...
def start_rsync(deck,run_srcpath,mirrpath):
    ...
    set_run_status(run_name,'syncing',last_sync=last_start)
